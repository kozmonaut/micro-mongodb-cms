...
| 
| $config['img_path'] = 'localhost:81/micromongoblog/images/somefolder';
| 
| -------------------------------------------------------------------*/

	$config['img_path'] = 'images/uploads'; // Relative to domain name
	$ex['extras'] = '/micromongoblog/';
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $ex['extras'] . $config['img_path']; // Physical path. [Usually works fine like this]
